...
GUIDES = [
    ...
    },
    {
        ...
        'meta_desc': "The free open-source Headroom proxy — cut your Claude Code / Cursor / Codex token bill 60–95% with zero code changes.",
        'kicker': 'CLAUDE CODE · HEADROOM',
        'h1_pre': 'Kill Your Claude Code Bill by',
        'h1_accent': '92%',
        'lede': "A Netflix engineer just open-sourced the layer that sits between your coding agent and the model. Compresses everything before it costs a token. Same answers, fraction of the price.",
        'callout': "Headroom is free, open-source, and runs locally. Wrap Claude Code in one command. Same output. 60–95% fewer tokens. This guide is the whole setup.",
        'inside': [
            ('💸', 'Why your Claude Code bill keeps climbing — the context tax nobody explains'),
            ('⚡', 'The one-line install + <em>headroom wrap claude</em> — zero code changes'),
            ('📉', 'The receipts: 92% fewer tokens, ±0.000 accuracy hit, on real benchmarks'),
            ('🧠', 'The sleeper learn mode — writes fixes straight into your CLAUDE.md'),
        ],
        'dl_items': [
